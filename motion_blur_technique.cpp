...
bool MotionBlurTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/dev/projects/shaders/shaders6_3/motion_blur.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/dev/projects/shaders/shaders6_3/motion_blur.fs")) {
        return false;
    }
